  ...
  <el-card class="card-layout">
    <el-form :model="article" ref="article" :rules="rules" label-width="100px" style="width: 80%;margin:auto">
      <el-form-item label="标题:" prop="name">
        <el-input v-model="article.name" size="small" type="text" maxlength="50" show-word-limit style="width: 36%"
                  placeholder="请输入标题名称"/>
      </el-form-item>
      <el-form-item label="医生名:" prop="doctorName">
        <el-input v-model="article.doctorName" size="small" type="text" maxlength="10" show-word-limit
                  style="width: 36%" placeholder="请输入医生名"/>
      </el-form-item>
...
<script>
  ...
  import {addArticle, findHealthThemeAll} from '@/api/health/index'
