<template>
  <el-card class="card-layout">
    <el-form :model="video" ref="article" :rules="rules" label-width="100px" style="width: 40%;margin:auto">
      ...
      <br/>
      <br/>
      <el-form-item label="视频预览:" prop="url" v-show="true">
        <video width="320" :src="src" height="240" controls id="upvideo"></video>
      </el-form-item>
    </el-form>
...
<script>
  ...
  import {addVideo, findHealthThemeAll} from '@/api/health/index'
